...
print('Welcome to the Servarr Installation Helper')
...
print('\n===CONFIGURATION===')
print('Please enter your timezone (default "Europe/Rome")', end=' ')
timezone = input()
if len(timezone) == 0:
...
print('Where would you like to keep your files? (Insert /, it will create /data/...)', end=' ')
